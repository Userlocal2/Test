...
$kol = $this->clientmodel->m_sel_kol($urll);
		...
		$obj = $this->clientmodel->getPage(341);
...
//echo $data['lang'].base_url().'order';
                                   //redirect($data['lang'].'/order' , 'refresh');
...
/*2.05*/
	 if ($_SERVER['QUERY_STRING']=='test') {
            ...
            echo "<pre>";
            var_dump($_SESSION['order_id']);
            var_dump($_SESSION['order_amount']);
            echo "</pre>";
        }
...
// print_r($_SESSION);
 ...
 $data['order_id'] = $_SESSION['order_id'];
        $data['order_amount'] = $_SESSION['order_amount'];
