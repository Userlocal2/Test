...
//$translate_it=json_decode(file_get_contents('http://mymemory.translated.net/api/get?q=Hello World!&langpair=en|it'));

//$xml = simplexml_load_string('https://translate.yandex.net/api/v1.5/tr/translate?key=trnsl.1.1.20140514T190837Z.500fa096ab7f01eb.d61fbb77ec1c02ea8414f778dbe7dd0384fa7ba0&lang=en-ru&text=Hello');
//var_dump($xml);
...
$obj = $this->clientmodel->getPage(343);
...
$data['desc'] = $obj->metadesc;
$data['key']= $obj->metakey;
...
$kol = $this->clientmodel->m_sel_kol($urll);
	...
	/*вывод метатегов для всей стр*/	/*$obj = $this->clientmodel->getPage(341);*/
...
if ($urlCategory == 'Abstract')

{


$data['title'] = 'Custom wall murals from Walldeco - Abstract'; 
$data['desc'] = 'Abstract Wall Mural from Walldeco allow you to decorate your house with real works of contemporary art. On our site you can select any image you want, specify the desired size, as well a shipping adress. Free shipping across Canada.';
$data['key']= 'Abstract wall murals, abstract murals, wall murals';
...
//print_r($urlCategory);
if ($urlCategory == 'Animals')

{


$data['title'] = 'Custom wall murals from Walldeco - Animals'; 
$data['desc'] = 'Wall Mural with an image of an animal can be a great decoration choice for any home, office, or other premises. On our site you'."'".'ll find a variety of pictures with animals, to suit the size of your walls. Place an order with free delivery in Canada.';
$data['key']= 'animals wall murals, animal murals, wall murals animals, cat murals, dog murals, elephant wall murals, bear murals, bird wall murals, wolf murals, tiger murals';

    
//echo "Yes";    
}
if ($urlCategory == 'Architecture')

{


$data['title'] = 'Custom wall murals from Walldeco - Architecture'; 
$data['desc'] = 'Selecting a picture for your walls from the architecture category, you can decorate a room with an architectural masterpieces. (images of churches, houses, bridges, etc.)';
$data['key']= 'wall, murals, wall, murals, architecture, building, houses, churches';
...
if ($urlCategory == 'Backgrounds')

{


$data['title'] = 'Custom wall murals from Walldeco - Backgrounds'; 
$data['desc'] = 'Wall Mural with backgrounds and patterns look great in any interior. Walldeco offers you the opportunity to order Wall Murals with an image you like, with an optimum size and free delivery in Canada.';
$data['key']= 'Murals background, murals pattern, wall murals background, wall murals pattern';
...
$data['title'] = 'Custom wall murals from Walldeco - Business'; 
$data['desc'] = 'Wall Mural from the business category are ideal for decorating an office space. Using the services of Walldeco you will be able to choose the size, texture and image you want. We also offer free shipping across Canada';
$data['key']= 'business wall murals, office wall murals, business murals, office murals, business days wall murals, business days murals, business days custom murals ';
...
$data['title'] = 'Custom wall murals from Walldeco - Food'; 
$data['desc'] = 'Wall Mural with images from the "food" category are ideal for decoration dining rooms, kitchens, cafes and restaurants. With the ability to choose your image and the size you can get the  perfect look for your home.';
$data['key']= 'food murals, food wall murals, food, drink, food and drink murals, food and drink wall murals';
...
$data['title'] = 'Custom wall murals from Walldeco - Maps'; 
$data['desc'] = 'Wall Murals with images from the maps category are ideal to decorate your office, living room or other premises. A large selection of images and textures for wall murals can be ordered individually sized with free shipping in Canada.';
$data['key']= 'wall murals map, wall murals europe, wall murals map canada, wall murals north america';
...
if ($urlCategory == 'Musical')

{


$data['title'] = 'Custom wall murals from Walldeco - Musical'; 
$data['desc'] = 'Wall Mural from the "musical" category are ideal for creative people, and for those who simply love good music. Walldeco company offers its customers an opportunity to choose the size and image for photo wallpapers and free shipping across Canada.';
$data['key']= 'Musical wall murals, musical murals';
...
if ($urlCategory == 'Nature')

{


$data['title'] = 'Custom wall murals from Walldeco - Nature'; 
$data['desc'] = 'Wall Mural with images from the nature category will appeal to parents and children. We offer our customers an opportunity to determine the size of the wall mural along with free shipping across Canada.';
$data['key']= 'murals Nature, murals wild nature, wall murals nature, wall murals wild nature';
...
if ($urlCategory == 'Objects')

{


$data['title'] = 'Custom wall murals from Walldeco - Objects'; 
$data['desc'] = 'Wall Mural with images from the objects category will allow you to look at familiar things differently. We offer high quality Wall Murals with different types of images and textures, with free shipping across Canada.';
$data['key']= 'wall murals objects, murals objects';

    
//echo "Yes";    
}

if ($urlCategory == 'People')

{


$data['title'] = 'Custom wall murals from Walldeco - People'; 
$data['desc'] = 'Walldeco company offers quality Wall Mural depicting people. We provide an opportunity to choose the size and image for photo wallpapers, and free shipping across Canada.';
$data['key']= 'murals people, people murals, wall murals people, wall murals male, wall murals female';

    
//echo "Yes";    
}

if ($urlCategory == 'Places')

{


$data['title'] = 'Custom wall murals from Walldeco - Places'; 
$data['desc'] = 'Wall Mural images from the places category can move into your home views of cities, villages, and beautiful places. Walldeco company offers its customers the opportunity to choose the texture and sizeof your wall murals. We also provide free shipping across Canada.';
$data['key']= 'murals places, wall murals places';
...
$data['title'] = 'Custom wall murals from Walldeco - Sports'; 
$data['desc'] = 'Murals with images from the sport category are ideal for those who love sports and those who need motivation to exercise. Wall Mural with sports pictures are well suited for clearance gyms and playgrounds.';
$data['key']= 'Murals sports, sport wall murals, wall murals sports';

    
//echo "Yes";    
}

if ($urlCategory == 'Transportation')

{


$data['title'] = 'Custom wall murals from Walldeco - Transportation'; 
$data['desc'] = 'Mural from the category transportion will look good in the homes of young, active people. In catalog you can select pictures with cars, trains, ships and boats, space shuttles, etc. Using the services of the company Walldeco, you can order murals with optimal size and texture with free shipping across Canada.';
$data['key']= 'Transportation Wall Murals, Open road wall murals, Road wall murals, cars wall murals, trains wall murals, boats wall murals, ships wall murals, space shuttles wall murals';
...
$isValidData = 1;
        ...
        $data['lastname'] = $_SESSION['name_last'];
...
//$this->load->client_view('head_price', $data);

$data['am'] = ($_SESSION['post']['amount']);
...
$obj = $this->clientmodel->getPage(342);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////TEXTURA
	public function textura()
	{
		...
		$obj = $this->clientmodel->getPage(147);
