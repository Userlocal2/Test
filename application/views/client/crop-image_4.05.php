...
if($.trim(firstname.val()).length == 0 || $.trim(firstname.val()).length > 50){
...
if($.trim(city.val()).length < 2 || $.trim(city.val()).length > 19){
...
if($.trim(country.val()).length < 2 || $.trim(country.val()).length > 19){
...
if($.trim(state.val()).length < 2 || $.trim(state.val()).length > 19){
...
if($.trim(zip.val()).length < 2 || $.trim(zip.val()).length > 19){
...
if($.trim(email.val()).length < 1 || $.trim(email.val()).length > 19){
