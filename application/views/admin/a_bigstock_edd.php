...
?>
	...
	<div class="nav">
		<form id="form_gallery" action="<?=base_url();?>administrator/sel_photo_edit" method="GET" enctype="multipart/form-data">
			<b>категория</b>
...
<option <?=$kk;?> value="<?=$kk;?>"><?=$kk;?> </option>                        
			...
			<a class="link_add" href="<?=base_url(); ?>/administrator/Gallery_edit/?add&id_cat=<?=$cat_id?>" title="добавить"></a>
