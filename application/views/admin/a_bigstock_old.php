...
?>
	...
	<div class="nav">
		<form id="form_gallery" action="<?=base_url();?>administrator/gallery/" method="GET" enctype="multipart/form-data">
			<b>категория</b>
...
<!--<option <?=$k->name;?> value="<?=$k->name;?>"><?=$k->name;?> </option>-->                
