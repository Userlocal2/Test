...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////__CALLBACK
	public function callBack()
	{
		...
		if(!empty($phone)){
			...
			$msg = '<html>
						<head>
						  <title>Callback order uwalls.com</title>
						</head>
						<body>
            ...
            $to = 'sale@uwalls.com';//'site@art-murals.ca';//'site@art-murals.ca';//'walldeco.klever@gmail.com';//'site@walldeco.com.ua';  
            $headers = 'From: uwalls.com <site@art-murals.ca>' . "\r\n";
            $headers.= 'Content-type: text/html; charset="utf-8"';

            $subject = "Callback order uwalls.com";
...
$amou = htmlspecialchars(trim($_POST['amount']));
/*end_new_filds*/
...
$msg = '<html>
					...
					<body>
						<h2 style="text-align:center; font-weight:normal;color:#fff;background:#53afea;margin:0;">Message from the page trim uwalls.com</h2>
						<table width="100%" cellpadding="4" cellspacing="0" style="border-collapse:collapse;font-size:14px;">
...
<tr>
								<td width="150px" align="right" style="border:1px solid #ccc;background:#eee;"><small>Price: </small></td>
								<td align="left" style="border:1px solid #ccc">'.$amou.'</td>
							</tr>                        
...
<tr>
       ...
       //echo $msg;
        ...
        $subject = "Image_order uwalls.com";
        
        $send = mail($to,$subject,$msg,$headers);
		return true;
	}

    public function payment_recive($data) {

        $msg='<html>
                    <head>
                      <title>Order_pay uwalls.com</title>
                    </head>
                    <body>
                        <h2 style="text-align:center; font-weight:normal;color:#fff;background:#53afea;margin:0;">Сообщение об оплате заказа art-murals.ca</h2>
                        <p>Получена оплата за заказ №'.$data['order']->id.'</p>
                    </body>
                </html>';
        ...
        $subject = "Order_pay art-murals.ca";
        
        $send = mail($to,$subject,$msg,$headers);
        //$send = mail('sergey@psyho.ua',$subject,$msg,$headers);
        return true;
    }
